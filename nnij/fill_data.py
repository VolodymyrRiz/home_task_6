...
def prepare_data(groups_nnij, students_nnij, teachers_nnij, subjects_nnij, marks_nnij) -> tuple():
    for_groups = []
    ...
    return  groups_nnij, for_students, for_teachers, for_subjects, for_marks


def insert_data_to_db(groups_nnij, students_nnij, teachers_nnij, subjects_nnij, marks_nnij) -> None:
    # Створимо з'єднання з нашою БД та отримаємо об'єкт курсору для маніпуляцій з даними
    print('kkkkkkkkkkkkkkkk', groups_nnij)
    with sqlite3.connect('nnij_new.db') as con:
        ...
        cur.executemany(sql_to_students_nnij, students_nnij)
        ...
        cur.executemany(sql_to_teachers_nnij, teachers_nnij)
        ...
        cur.executemany(sql_to_subjects_nnij, subjects_nnij)         
        ...
        cur.executemany(sql_to_marks_nnij, marks_nnij)
...
if __name__ == "__main__":
    ...
    insert_data_to_db(groups_nnij, students_nnij, teachers_nnij, subjects_nnij, marks_nnij)
